...
if not st.session_state.get("is_admin"):
    ...
    .si-l {{ background: #070b14; padding: 2.2rem; display: flex; flex-direction: column; justify-content: space-between; }}
...
.card-footer-content { padding: 1rem 0 0 0; margin-top: auto; }
