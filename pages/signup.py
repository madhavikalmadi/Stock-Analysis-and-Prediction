...
# ── Inject full-page CSS reset (Matching Login Theme) ────────────────
st.markdown("""
<style>
    ...
    .si-step {
        display: flex; align-items: flex-start; gap: 12px; margin-bottom: 1.2rem;
    }
    .si-step-num {
        width: 20px; height: 20px; border-radius: 50%; background: #1e293b;
    ...
    .si-field input {
        ...
        padding: 0.58rem 0.92rem; outline: none; font-family: inherit;
    ...
    .si-btn {
        ...
        margin-top: 0.5rem; letter-spacing: 0.2px; font-family: inherit;
    ...
    .si-back {
        text-align: center; margin-top: 1.2rem; font-size: 0.85rem; color: #64748b;
    }
    .si-back-link {
        color: #10b981; font-weight: 700; cursor: pointer; text-decoration: none;
    }
...
<span class="si-name">Join Smart Investor</span>
</div>
<div class="si-headline">
<h2>Start your journey to <em>financial freedom</em></h2>
<p>Create an account to track indices, compare stocks, and leverage institutional-grade risk metrics.</p>
</div>
<div class="si-steps">
<div class="si-step">
<div class="si-step-num">1</div>
<div class="si-step-txt">Create your profile with basic details</div>
</div>
<div class="si-step">
<div class="si-step-num">2</div>
<div class="si-step-txt">Connect to real-time market data</div>
</div>
<div class="si-step">
<div class="si-step-num">3</div>
<div class="si-step-txt">Build and analyze your portfolio</div>
</div>
</div>
</div>
<div class="si-left-foot">
Join 5,000+ investors making data-driven<br>decisions every day.
</div>
</div>
<div class="si-right">
...
<input type="tel" id="regMob" placeholder="Enter mobile number" required />
</div>
<div class="si-row">
<div class="si-field">
...
<div class="si-field">
<label>Confirm</label>
<input type="password" id="regConf" placeholder="••••••••" required />
</div>
</div>
...
url.searchParams.set('__reg_email', encodeURIComponent(e));
...
# ── Handle query-param based registration submissions ─────────────
qp = st.query_params
...
if "__reg_user" in qp:
    ...
    if auth_utils.signup_user(u, p, e, m):
        ...
        # For better UX, let's auto-login or redirect
        # Let's redirect to login after a short delay
        import time
        time.sleep(2)
        st.switch_page("login.py")
    else:
        st.error("❌ Failed to create account. Username might already exist or password too short.")
